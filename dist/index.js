...
class ReleaseClient {
     ...
     */
    uploadAssets(packageName, version, assets) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const asset of assets) {
                formData.append("files", fs_1.default.createReadStream(asset));
            }
            try {
                yield axios_1.default.post(`${this.endpoint}/release`, formData, {
...
function application() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const assets = assetsString.split(",");
        const client = new client_1.ReleaseClient(endpoint, username, password);
        yield client.uploadAssets(packageName, version, assets);
    });
}
